...
import { RemoteStartTransactionInput } from '@/application/dto/input/RemoteStartTransactionInput';
import { RemoteStartTransactionOutput } from '@/application/dto/output/RemoteStartTransactionOutput';
